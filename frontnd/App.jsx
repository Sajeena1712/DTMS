...
const DTMSWorkflowPage = lazy(() => import("./pages/recruitment/DTMSWorkflowPage"));
const NotificationsPage = lazy(() => import("./pages/notifications/NotificationsPage"));
const AIInterviewPage = lazy(() => import("./pages/recruitment/AIInterviewPage"));
const FinalSelectionPage = lazy(() => import("./pages/recruitment/FinalSelectionPage"));
          ...
          <Suspense fallback={<RouteLoader />}>
            <Routes>
              ...
              <Route element={<ProtectedRoute><AuthedLayout /></ProtectedRoute>}>
                ...
                <Route path="/dtms-workflow" element={<DTMSWorkflowPage />} />
                <Route path="/notifications" element={<NotificationsPage />} />
                <Route path="/screening-interview" element={<Navigate to="/dtms-workflow" replace />} />
