      ...
      >
        <div className="flex items-start justify-between gap-4">
          ...
          <div className="flex flex-col items-end gap-2">
            <button
              ...
              disabled={generating}
              className="rounded-2xl bg-gradient-to-r from-blue-600 via-sky-500 to-cyan-400 px-4 py-2 text-sm font-semibold text-white transition hover:-translate-y-0.5 disabled:cursor-not-allowed disabled:opacity-60"
            >
            ...
            <button
              ...
              disabled={generating}
              className="rounded-2xl border border-sky-300/30 bg-white/8 px-4 py-2 text-sm font-semibold text-white transition hover:bg-white/12 disabled:cursor-not-allowed disabled:opacity-60"
            >
              {generating ? "Generating..." : "Description only"}
            </button>
            <button
              type="button"
              onClick={onClose}
        ...
        <form className="mt-8 grid gap-5" onSubmit={handleSubmit}>
          ...
          <div className="rounded-2xl border border-white/15 bg-white/8 p-4 backdrop-blur">
            ...
            <div className="mt-4 grid gap-4 sm:grid-cols-2">
              <label className="grid gap-2">
                <span className="text-xs font-semibold uppercase tracking-[0.24em] text-white/60">Priority</span>
                <select
                  name="priority"
                  value={form.priority}
                  onChange={updateField}
          ...
          {aiDraft ? (
            <div className="rounded-2xl border border-blue-200/20 bg-white/8 p-4 backdrop-blur">
              <div className="flex flex-wrap items-center justify-between gap-2">
                <div>
                  <p className="text-xs uppercase tracking-[0.28em] text-blue-200">AI draft</p>
              ...
              {aiDraft.scoreBreakdown ? (
                <div className="mt-4 grid gap-2 text-xs text-slate-300 sm:grid-cols-2">
                  <div className="rounded-2xl border border-white/8 bg-white/5 px-3 py-2">Clarity: {aiDraft.scoreBreakdown.clarity}/25</div>
                  <div className="rounded-2xl border border-white/8 bg-white/5 px-3 py-2">Completeness: {aiDraft.scoreBreakdown.completeness}/25</div>
                  <div className="rounded-2xl border border-white/8 bg-white/5 px-3 py-2">Specificity: {aiDraft.scoreBreakdown.specificity}/20</div>
                  <div className="rounded-2xl border border-white/8 bg-white/5 px-3 py-2">Feasibility: {aiDraft.scoreBreakdown.feasibility}/15</div>
                  <div className="rounded-2xl border border-white/8 bg-white/5 px-3 py-2 sm:col-span-2">Context: {aiDraft.scoreBreakdown.context}/15</div>
                </div>
              ) : null}
              {aiDraft.analysis ? (
                <p className="mt-4 rounded-2xl border border-white/8 bg-white/5 px-4 py-3 text-sm leading-6 text-slate-200">
                  <span className="block text-xs font-semibold uppercase tracking-[0.2em] text-slate-400">Analysis</span>
