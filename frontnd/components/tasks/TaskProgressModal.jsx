  ...
  useEffect(() => {
    ...
    setLink(
      task.submission?.githubUrl ||
        (task.submission?.fileUrl?.startsWith("http") ? task.submission.fileUrl : ""),
    );
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      <motion.aside
        ...
        className="absolute inset-y-0 right-0 z-10 w-full max-w-4xl overflow-y-auto border-l border-slate-200/20 bg-[linear-gradient(180deg,#ffffff_0%,#f8fbff_45%,#f5f7fb_100%)] p-6 shadow-[0_30px_90px_rgba(2,6,23,0.32)] sm:p-8"
      >
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-3 max-w-2xl text-sm leading-7 text-slate-600">
              Paste your GitHub repository link, upload your project PDF or file, and submit the update. This flow is for users only.
            </p>
            {lateSubmissionReason ? (
        ...
        <form className="mt-8 grid gap-5" onSubmit={handleSubmit}>
          <div className="rounded-2xl border border-slate-200/80 bg-white p-4 shadow-sm">
            ...
            <div className="mt-4 grid gap-4 sm:grid-cols-2">
              ...
              <label className="grid gap-2">
                <span className="text-xs font-semibold uppercase tracking-[0.24em] text-slate-500">GitHub repository link</span>
                <input
                  value={link}
            ...
            <label className="mt-4 grid gap-2">
              <span className="text-xs font-semibold uppercase tracking-[0.24em] text-slate-500">Project PDF or file</span>
              <input
                type="file"
              ...
              <p className="text-xs text-slate-500">
                Upload your PDF report, project archive, or supporting file here. The GitHub link above will be used for code review signals.
              </p>
            </label>
          </div>
          ...
          <div className="flex items-center justify-between gap-4">
            <p className="text-sm text-slate-500">Click submit when you are ready. AI will analyze the submission automatically.</p>
            <button
              type="submit"
