...
const rotatingLines = [
  ...
  "Secure your DTMS account",
  "Recover access safely",
  "Get back to your workflow quickly",
];
...
export default function ResetPasswordPage() {
  ...
  async function onSubmit(values) {
    if (!token) {
      showApiError(new Error("Reset token is missing in this link"), "Reset token is missing");
      return;
    }
    ...
    try {
      ...
      showApiError(error, "Unable to reset password");
    } finally {
      setLoading(false);
    }
  }
      ...
      <div className="relative mx-auto grid min-h-screen max-w-7xl gap-6 px-5 py-5 lg:grid-cols-[1.08fr_0.92fr] lg:px-10 lg:py-8">
        ...
        >
          ...
          <div className="absolute inset-x-0 bottom-0 p-10">
            <div className="max-w-lg rounded-[28px] border border-white/70 bg-white/40 p-8 backdrop-blur-xl">
              ...
              <h1 className="mt-5 text-4xl font-semibold leading-tight text-slate-900">Reset your password</h1>
        ...
        <div className="flex items-center justify-center">
          ...
          >
            ...
            <h2 className="mt-4 text-center text-4xl font-semibold text-slate-900">Reset Password</h2>
            ...
            {!token ? (
              <p className="mt-6 rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-700">
                Reset token is missing. Please open the reset link from your email or server log.
              </p>
            ) : null}
